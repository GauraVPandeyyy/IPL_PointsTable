        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/GauraVPandeyyy" className="hover:text-gray-300 transition-colors">GitHub</a>
              <a href="https://x.com/gaura_vp9118" className="hover:text-blue-300 transition-colors">Twitter</a>
            </div>
          </div>
        </div>
